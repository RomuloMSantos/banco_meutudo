...
INSERT INTO SIMULADOR.MOVIMENTACAO (TIPO, TIPO_TRANSACAO, VALOR, CONTA_FK) VALUES (1, 2, 5000, (SELECT ID FROM SIMULADOR.CONTA ORDER BY ID DESC LIMIT 1));
...
INSERT INTO SIMULADOR.MOVIMENTACAO (TIPO, TIPO_TRANSACAO, VALOR, CONTA_FK) VALUES (1, 2, 10000, (SELECT ID FROM SIMULADOR.CONTA ORDER BY ID DESC LIMIT 1));
...
INSERT INTO SIMULADOR.MOVIMENTACAO (TIPO, TIPO_TRANSACAO, VALOR, CONTA_FK) VALUES (1, 2, 20000, (SELECT ID FROM SIMULADOR.CONTA ORDER BY ID DESC LIMIT 1));
...
INSERT INTO SIMULADOR.MOVIMENTACAO (TIPO, TIPO_TRANSACAO, VALOR, CONTA_FK) VALUES (1, 2, 30000, (SELECT ID FROM SIMULADOR.CONTA ORDER BY ID DESC LIMIT 1));
